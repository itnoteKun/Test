...
public class regionTempBean implements DBWritable, Writable {
    ...
    public void write(PreparedStatement preparedStatement) throws SQLException {
        ...
        preparedStatement.setString(2, tempMax);
        preparedStatement.setString(3, tempMin);
