...
public class moWeatherBean implements DBWritable, Writable {
    ...
    private Integer weatherSum;


    //空参构造
    public moWeatherBean(){
    ...
    public Integer getWeatherSum() { return weatherSum; }

    public void setWeatherSum(Integer weatherSum) { this.weatherSum = weatherSum; }
    ...
    public void write(PreparedStatement preparedStatement) throws SQLException {
        ...
        preparedStatement.setInt(3,weatherSum);
