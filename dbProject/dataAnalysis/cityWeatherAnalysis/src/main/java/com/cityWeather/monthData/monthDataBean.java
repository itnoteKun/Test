...
public class monthDataBean implements DBWritable, Writable {
    ...
    public void write(PreparedStatement preparedStatement) throws SQLException {
        ...
        preparedStatement.setString(4,tempMax);
        preparedStatement.setString(5,tempMin);
        preparedStatement.setString(6,windLevel);
