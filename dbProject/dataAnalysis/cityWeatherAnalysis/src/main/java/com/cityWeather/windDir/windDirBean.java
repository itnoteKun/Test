...
public class windDirBean implements DBWritable, Writable {
    //字段
    private int id;
    ...
    public String getWindDirNum() {
        return windDirNum;
    }

    public void setWindDirNum(String windDirNum) {
        this.windDirNum = windDirNum;
    }
    ...
    public void write(DataOutput dataOutput) throws IOException {
        ...
        dataOutput.writeUTF(windDirNum);
    }
    ...
    public void readFields(DataInput dataInput) throws IOException {
        ...
        this.windDirNum = dataInput.readUTF();
    }
    ...
    public void write(PreparedStatement preparedStatement) throws SQLException {
        ...
        preparedStatement.setString(3,windDir);
        preparedStatement.setString(4,windDirNum);
    }
