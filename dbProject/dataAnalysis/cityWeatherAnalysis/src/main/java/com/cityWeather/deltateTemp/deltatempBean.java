...
public class deltatempBean implements DBWritable, Writable {
    ...
    private Double standardAveTemp;

    //空参构造
    public deltatempBean(){
    ...
    public Double getStandardAveTemp() {
        return standardAveTemp;
    }

    public void setStandardAveTemp(Double standardAveTemp) {
        this.standardAveTemp = standardAveTemp;
    }
    ...
    public void write(PreparedStatement preparedStatement) throws SQLException {
        ...
        preparedStatement.setDouble(2,standardAveTemp);
